# 🍫 Yet Another Store for Choco

> A modern, premium GUI wrapper for the **Chocolatey** (`choco`) package manager.
...
**Yet Another Store for Choco** brings all that CLI power into a stunning, native-feeling graphical user interface. No more forgotten commands, no more syntax errors. Just pure, visual package management.
...
- **Official Website/Repository**: [Chocolatey](https://chocolatey.org)

## 🛠️ Requirements

- The `choco` command-line tool must be installed on your system and available in your shell's `PATH`.
...
```bash
git clone https://github.com/albertolicea00/yas-choco.git
cd yas-choco
cmake --preset default        # configure (Ninja, Debug)
cmake --build --preset default
.\build\default\yas-choco.exe
```
...
- 🐛 [Report a bug](https://github.com/albertolicea00/yas-choco/issues/new?template=bug_report.md)
- 💡 [Request a feature](https://github.com/albertolicea00/yas-choco/issues/new?template=feature_request.md)

## ⚖️ License & Legal

**Yet Another Store for Choco** is released under the **[MIT License](LICENSE)**.
...
Third-party tools (primarily **Chocolatey**) are not bundled and governed by their own licenses.
